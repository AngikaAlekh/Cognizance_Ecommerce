...
@section('content')
    <div class="untree_co-section before-footer-section">
        <div class="container py-5">
            <div class="row mb-5">
                <form class="col-md-12" method="post" action="{{ route('shop.cart.update', Auth::user()->id) }}" id="cart_form">
                    @csrf
                ...
                <div class="col-md-6">
                    <div class="row mb-5">
                        <div class="col-md-6 mb-3 mb-md-0">
                            <button class="btn btn-black btn-sm btn-block" onclick="document.getElementById('cart_form').submit()">Update Cart</button>
                        </div>
                        <div class="col-md-6">
